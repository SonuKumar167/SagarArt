...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['calculator_login'])) {
  ...
  $stmt = $conn->prepare('SELECT password_hash FROM admin_users WHERE username = ? and user_type = "calculator" LIMIT 1');
    ...
    <div class="container">
      <div class="row align-items-center gy-4">
        <div class="col-lg-8">
          ...
          <p class="text-muted">Select a product, choose quantity, and get a fast estimate for your print or signage order.</p>
